...
discarding the pre-menu payload. Godot's input mapping regression covers rfvp
...
after loading it. This is limited coverage: the current line was invisible
immediately after load and the next click displayed the following line. The
snapshot contained a hidden text parent, and upstream restoration discards
in-flight motions; full text/transition restoration remains unresolved.
The translation package's compressed script was not enabled for this run.

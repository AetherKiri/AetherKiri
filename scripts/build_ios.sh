...
FORCE_LOAD_PLUGIN_SOURCES=(
    ...
    "packages/krkr2/plugins/libkrkr2plugin.a"
    "packages/krkr2/plugins/extkagparser/libextkagparser.a"
    "packages/krkr2/plugins/kagparserex/libkagparserex.a"
    "packages/krkr2/plugins/layerex_draw/liblayerExDraw.a"
    "packages/krkr2/plugins/motionplayer/libmotionplayer.a"
    "packages/krkr2/plugins/psbfile/libpsbfile.a"
    "packages/krkr2/plugins/psdfile/libpsdfile.a"
    "packages/krkr2/plugins/psdfile/psdparse/psdparse/libpsdparse.a"
)
...
combine_ios_static_extension() {
    ...
    local libs=(
        ...
        "$CMAKE_BUILD_DIR/packages/krkr2/core/base/libcore_base_module.a"
        "$CMAKE_BUILD_DIR/packages/krkr2/core/environ/libcore_environ_module.a"
        "$CMAKE_BUILD_DIR/packages/krkr2/core/extension/libcore_extension_module.a"
        "$CMAKE_BUILD_DIR/packages/krkr2/core/movie/libcore_movie_module.a"
        "$CMAKE_BUILD_DIR/packages/krkr2/core/plugin/libcore_plugin_module.a"
        "$CMAKE_BUILD_DIR/packages/krkr2/core/sound/libcore_sound_module.a"
        "$CMAKE_BUILD_DIR/packages/krkr2/core/tjs2/libtjs2.a"
        "$CMAKE_BUILD_DIR/packages/krkr2/core/utils/libcore_utils_module.a"
        "$CMAKE_BUILD_DIR/packages/krkr2/core/visual/libcore_visual_module.a"
        "$CMAKE_BUILD_DIR/packages/krkr2/core/visual/simd/libtvpgl_simd.a"
        "$CMAKE_BUILD_DIR/packages/krkr2/plugins/libkrkr2plugin.a"
        "$CMAKE_BUILD_DIR/packages/krkr2/plugins/extkagparser/libextkagparser.a"
        "$CMAKE_BUILD_DIR/packages/krkr2/plugins/kagparserex/libkagparserex.a"
        "$CMAKE_BUILD_DIR/packages/krkr2/plugins/layerex_draw/liblayerExDraw.a"
        "$CMAKE_BUILD_DIR/packages/krkr2/plugins/motionplayer/libmotionplayer.a"
        "$CMAKE_BUILD_DIR/packages/krkr2/plugins/psbfile/libpsbfile.a"
        "$CMAKE_BUILD_DIR/packages/krkr2/plugins/psdfile/libpsdfile.a"
        "$CMAKE_BUILD_DIR/packages/krkr2/plugins/psdfile/psdparse/psdparse/libpsdparse.a"
        "$CMAKE_BUILD_DIR/packages/krkr2/plugins/libCubismFramework.a"
        "$CMAKE_BUILD_DIR/packages/krkr2/external/libbpg/liblibbpg.a"
    )

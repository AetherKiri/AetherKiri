...
namespace {
    ...
    bool layerLooksLikeReplacementPresentation(
        tTJSNI_BaseLayer *layer) {
        if(!layer || centeredGameMotionStablePresentationLayer(layer) ||

...
func _rebuild_settings_view() -> void:
    ...
    if _iap_supported_platform():
        var purchase_group := _settings_group(page, _t("settings.section.purchases"), ICON_LIBRARY, animate_page, 0.155)
    ...
    var about_group := _settings_group(page, _t("settings.section.about"), ICON_HELP, animate_page, 0.18)
...
func _refresh_language_texts() -> void:
    ...
    if is_instance_valid(home_primary_button):
        ...
        home_primary_button.text = primary_text
